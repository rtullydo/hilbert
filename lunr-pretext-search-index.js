...
},
{
  ...
  "number": "5.5.2",
  "title": "",
  "body": " ( ): If , then for any , and are orthogonal. Then gives  ( : Now suppose that the inequality in holds. Pick an arbitrary and a scalar . As is a linear subspace, , and so Now we leverage inner product geometry. Notice that Now, we'll drop the real part of the inner product. Let be a unimodular constant so that (if you don't see why such a constant should exist, you should think about it). Then the inequality above holds in particular for vectors of the form where , which gives We can rearrange this into for all . Letting , we conclude that for all , and so .  "
},
{
...
},
{
  ...
  "number": "9.1.3",
  "title": "",
  "body": " Let be a Hilbert space and suppose that is a compact self-adjoint operator. Then the eigenvalues of are a finite set of real numbers, or the eigenvalues of are a countable sequence of real numbers tending to .  "
},
{
...
{
  "id": "thm-spectral-basis",
  "level": "2",
  "url": "compact-spec.html#thm-spectral-basis",
  "type": "Corollary",
  "number": "9.1.8",
  "title": "",
  "body": " Let be a compact self-adjoint operator on a separable Hilbert space . Then there exists a complete orthonormal sequence of eigenvectors of and for any ,   "
},
{
  "id": "compact-spec-17",
  "level": "2",
  "url": "compact-spec.html#compact-spec-17",
  "type": "Proof",
  "number": "9.1.3",
  "title": "",
